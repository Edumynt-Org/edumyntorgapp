                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          height: 24,
                          decoration: BoxDecoration(
                            color: isDark ? Theme.of(context).colorScheme.primary : AppColors.borderLight,
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Icon(Icons.arrow_forward, color: AppColors.error, size: 20),
                        ],
                      ),
                    ),
                  ),
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: Text('Sign Up', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w900)),
              ),
            ),
            SizedBox(height: 12),
            SizedBox(
              ...
              child: OutlinedButton(
                ...
                child: Text('Log In', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w900)),
              ),
            ),
          ],
        ),
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              shape: BoxShape.circle,
              border: Border.all(color: Theme.of(context).colorScheme.primary.withValues(alpha: 0.3), width: 4),
            ),
            child: Center(
              child: Text('U', style: TextStyle(fontSize: 36, fontWeight: FontWeight.w900, color: Theme.of(context).colorScheme.primary)),
            ),
          ),
          SizedBox(height: 16),
