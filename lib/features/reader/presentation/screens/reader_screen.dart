...
class _ReaderScreenState extends ConsumerState<ReaderScreen> {
  ...
  Future<void> _fetchData() async {
    ...
    if (mounted) {
      setState(() {
        if (bundle != null) {
          _toc = bundle.editionStructures[widget.editionId] ?? [];
        }
                            ...
                            children: [
                                ...
                                children: [
                                  Expanded(
                                    child: ElevatedButton(
                                      ...
                                      style: ElevatedButton.styleFrom(backgroundColor: colorScheme.surface, foregroundColor: onSurface, elevation: 0, padding: const EdgeInsets.symmetric(vertical: 16)),
                                ...
                                children: [
                                  Expanded(
                                    child: OutlinedButton(
                                      onPressed: () {
                                        setState(() => _fontFamily = 'PlusJakartaSans');
                                        setModalState(() {});
                                      },
                                ...
                                children: [
                                  Expanded(
                                    child: OutlinedButton(
                                      ...
                                      style: OutlinedButton.styleFrom(
                                        side: BorderSide(color: !themeProviderNotifier.isDarkMode ? colorScheme.primary : borderColor),
                                        backgroundColor: !themeProviderNotifier.isDarkMode ? colorScheme.primary.withValues(alpha: 0.1) : Colors.transparent,
                                        padding: const EdgeInsets.symmetric(vertical: 16),
                                      ),
                              ...
                              Center(
                                child: TextButton(
                                  ...
                                  child: Text('Reset to Default', style: TextStyle(color: onSurfaceMuted, fontWeight: FontWeight.bold, decoration: TextDecoration.underline)),
                                ),
                              ),
                              const SizedBox(height: 48),
                            ],
  ...
  void _handleHorizontalSwipe(DragEndDetails details) {
    ...
    int currentIndex = flatToc.indexWhere((c) => c.id == widget.chapterId || c.title == _chapterContent?['title']);
        ...
        child: Stack(
          children: [
            ...
            SingleChildScrollView(
              ...
              padding: const EdgeInsets.only(top: 100, bottom: 200, left: 24, right: 24), // Extra bottom padding for mini player
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(
                  ...
                  if (_chapterContent?['content'] != null && _chapterContent!['content'] is Map)
                    LexicalRenderer(
                      document: _chapterContent!['content'] as Map<String, dynamic>,
                      baseStyle: TextStyle(
                        fontFamily: _fontFamily,
                        fontSize: _fontSize,
                        height: 1.8,
                    ...
                    Text(
                      _chapterContent?['content'] is String ? _chapterContent!['content'] : 'No content available.',
                      style: TextStyle(
                        fontFamily: _fontFamily,
                        fontSize: _fontSize,
                        height: 1.8,
                  ...
                  Row(
                    children: [
                      if (hasPrev)
                        Expanded(
                          child: ElevatedButton(
                            onPressed: () => context.pushReplacement('/book/${widget.slug}/${widget.editionId}/${flatToc[currentIndex - 1].id}'),
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      IconButton(
                        icon: Text('Aa', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: isDark ? Colors.white : Colors.black)),
  ...
  Widget _buildTocDrawer(bool isDark, int currentIndex, List<TocItemModel> flatToc) {
    return Drawer(
      backgroundColor: isDark ? AppColors.backgroundDark : AppColors.backgroundLight,
      child: SafeArea(
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text('Table of Contents', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: isDark ? Colors.white : Colors.black)),
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    onTap: () {
                      ...
                      if (!isCurrent) context.pushReplacement('/book/${widget.slug}/${widget.editionId}/${item.id}');
                    },
                  );
                },
              ),
